...
# with command line options: l1NtupleRAWEMU_2023_16_26 -s RAW2DIGI --era=Run3 --customise=L1Trigger/Configuration/customiseReEmul.L1TReEmulFromRAWsimEcalTP --customise=L1Trigger/L1TNtuples/customiseL1Ntuple.L1NtupleRAWEMU --customise=L1Trigger/Configuration/customiseSettings.L1TSettingsToCaloParams_2023_v0_3 --conditions=130X_dataRun3_Prompt_v4 -n 2000 --data --no_exec --no_output --filein=/store/data/Run2023C/ZeroBias/RAW/v1/000/367/883/00000/006b965f-d265-4a55-b954-37ce894feee7.root
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/data/Run2023C/ZeroBias/RAW/v1/000/367/883/00000/00de551a-c9ce-4875-9f85-a8d6112c0aca.root'),  #'/store/data/Run2023C/ZeroBias/RAW/v1/000/367/883/00000/006b965f-d265-4a55-b954-37ce894feee7.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('l1NtupleRAWEMU_2023_new nevts:2000'),
